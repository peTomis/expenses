...
class CategoriesPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final data = computeCategoryExpenseTotals(financialData.monthlyData, categories);
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(Icons.tune, size: 15, color: textColor.withValues(alpha: 0.6)),
                        ...
                        child: Row(
                          children: [
                            for (final item in data) ...[
                              Expanded(
                                flex: (item.percentage * 10).round().clamp(1, 100000),
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: Icon(item.category.icon, size: 19, color: item.color),
                            ),
